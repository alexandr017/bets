...
Route::group(['prefix' => 'football', 'namespace' => 'API\Football', 'as' => 'football.', 'middleware' => 'api'], function () {
    ...
    Route::resource('admin/categories', 'Admin\FootballCategoriesController')->except(['create','update']); // CRUD
    ...
    Route::resource('admin/tours', 'Admin\FootballToursController')->except(['create','update']); // CRUD
    ...
    Route::resource('admin/matches', 'Admin\FootballMatchesController')->except(['create','update']); // CRUD
    ...
    Route::get('admin/bets/get-all-user-bets/{userID}', 'Admin\FootballBetsController@getAllUserBets')->name('bets.admin.get-all-user-bets');
